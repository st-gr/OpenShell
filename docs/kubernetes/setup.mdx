...
| `server.runtimeClassOuterIsolation` | Treat the configured RuntimeClass as the sandbox's outer kernel isolation boundary. Set explicitly for gVisor, GKE Sandbox, or Kata RuntimeClasses. |
