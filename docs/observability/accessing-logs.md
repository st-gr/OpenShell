...
For durable log storage, use the log files inside the sandbox or enable [OCSF JSON export](ocsf-json-export.md) and ship the JSONL files to an external log aggregator.
...
- Learn how the [log formats](logging.md) work and how to read the shorthand.
- [Enable OCSF JSON export](ocsf-json-export.md) for machine-readable structured output.
