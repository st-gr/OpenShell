...
use openshell_core::proto::compute::v1::{
    ...
    GetCapabilitiesResponse, GetSandboxRequest, GetSandboxResponse, GpuSpec, ListSandboxesRequest,
...
impl VmDriver {
    ...
    async fn provision_sandbox_inner(
        ...
        let gpu_device = requested_gpu_device(sandbox_gpu(&sandbox));
...
fn validate_vm_sandbox(sandbox: &Sandbox, gpu_enabled: bool) -> Result<(), Status> {
    ...
    validate_gpu_request(sandbox_gpu(sandbox), gpu_enabled)?;
...
fn sandbox_gpu(sandbox: &Sandbox) -> Option<&GpuSpec> {
    sandbox
        .spec
        .as_ref()
...
#[allow(clippy::result_large_err)]
fn validate_gpu_request(gpu: Option<&GpuSpec>, gpu_enabled: bool) -> Result<(), Status> {
