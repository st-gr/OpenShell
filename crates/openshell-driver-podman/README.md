...
| CDI GPU devices | Explicit GPU resource device IDs when set, otherwise all NVIDIA GPUs | Exposes requested GPUs to GPU-enabled sandbox containers. GPU count requests are rejected by this driver. |
