...
# Pin the model to one that ChatGPT-account Codex users can reach and that is
# quick enough for the mechanical proposal loop. Override with DEMO_CODEX_MODEL
# if your account supports something different.
